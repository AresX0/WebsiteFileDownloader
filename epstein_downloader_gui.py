...
def ensure_playwright_browsers():
    ...
    try:
        ...
        # If importing Playwright failed, raise a clearer error so the higher-level installer can attempt pip install.
        ...
        try:
            ...
            if os.path.exists(self.queue_state_path):
                ...
                try:
                    ...
                    # previous runs).
                    if loaded_urls and all(is_placeholder_url(u) for u in loaded_urls):
